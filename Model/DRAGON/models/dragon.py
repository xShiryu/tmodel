...
class DRAGON(GeneralRecommender):
    ...
    def contrastive_loss(self, user_tensor, pos_item_tensor, neg_item_tensor):
        pos_distance = F.pairwise_distance(user_tensor, pos_item_tensor)
        neg_distance = F.pairwise_distance(user_tensor, neg_item_tensor)

        contrastive_loss = F.relu(neg_distance - pos_distance + self.contrastive_margin).mean()
    ...
    def forward(self, interaction):
        ...
        #triplet loss
        contrastive_loss = self.contrastive_loss(user_tensor, pos_item_tensor, neg_item_tensor)

        return pos_scores, neg_scores, contrastive_loss

    def calculate_loss(self, interaction):
        user = interaction[0]
        pos_scores, neg_scores, contrastive_loss = self.forward(interaction)
        ...
        return loss_value + reg_loss #+ contrastive_loss * self.contrastive_weight
